  ...
  return (
    <div>
        <div className='bg-[#0B0C0E] px-[80px]'>
            <div className='flex justify-between pt-[80px] content-center gap-[400px]'>
                <div className='min-w-[649px]'>
                    <h1 className='font-inter text-[60px] text-white'>Have something in mind?</h1>
                    <h1 className='font-inter text-[60px] text-white'>
                        <span><img src={profpic} alt="profpic"/></span>
